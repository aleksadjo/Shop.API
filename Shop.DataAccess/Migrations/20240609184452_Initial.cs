        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageProducts_Products_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerUseCases", x => new { x.CustomerId, x.UseCaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageProductFiles", x => new { x.FileId, x.ImageProductId });
                    table.ForeignKey(
                        name: "FK_ImageProductFiles_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageProductFiles_ImageProducts_ImageProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageProductFiles_ImageProductId",
                table: "ImageProductFiles",
